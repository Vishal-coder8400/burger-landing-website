    ...
    return (
        <div className=' pt-[5rem] pb-[3rem]'>
            ...
            <h1 className='heading'>
                burger made with <br /> love and <span className='text-red-600'>Care</span>
            </h1>
            {/* cards */}
            <div className='w-[90%] md:w-[80%] mt-[3rem] md:mt-[5rem] mb-[3rem] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[3rem]'>
                ...
                <div data-aos="fade-left" data-aos-anchor-placement="top-center">
                    <div className=' p-6 hover:bg-white rounded-lg transition-all duration-200'>
                        ...
                        <p className='mt-[0.2rem] text-black text-opacity-60 text-center'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Culpa omnis labore recusandae suscipit a repudiandae vel ad facilis perferendis iure?</p>
                    </div>
                </div>
                {/* 2nd card */}
