        ...
        <div className=' pt-[5rem] pb-[3rem] bg-gray-900'>
            <div className='w-[80%] pb-[2rem] border-b-[2px] border-b-gray-300 border-opacity-50 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[3rem] items-center'>
                ...
                <div>
                    ...
                    <p className='mt-[0.7rem] text-white opacity-60 hover:text-yellow-300 transition-all duration-200 cursor-pointer w-fit'>Aoo Tiki Burger</p>
                ...
                <p className='text-white text-[18px]'>Monday - Saturday : <span className=' text-yellow-300'>8am - 10pm</span></p>
                <p className='text-white text-[18px]'>Sunday <span className=' text-yellow-300'>8am - 11pm</span></p>
                {/* social icons */}
